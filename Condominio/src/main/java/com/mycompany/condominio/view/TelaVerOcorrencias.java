 ...
 * @author marih
 */
public class TelaVerOcorrencias extends javax.swing.JFrame {

    /**
     * Creates new form TelaMoradores
     */
    public TelaVerOcorrencias() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Ver Ocorrências");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TelaVerOcorrencias.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new TelaVerOcorrencias().setVisible(true);
            }
        });
    }
