 ...
 * @author marih
 */
public class TelaCriarTaxas extends javax.swing.JFrame {

    /**
     * Creates new form TelaMoradores
     */
    public TelaCriarTaxas() {
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TelaCriarTaxas.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new TelaCriarTaxas().setVisible(true);
            }
        });
    }
