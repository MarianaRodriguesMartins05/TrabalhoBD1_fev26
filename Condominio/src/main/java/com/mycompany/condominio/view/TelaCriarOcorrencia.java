 ...
 * @author marih
 */
public class TelaCriarOcorrencia extends javax.swing.JFrame {

    /**
     * Creates new form TelaMoradores
     */
    public TelaCriarOcorrencia() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Criar Ocorrência");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TelaCriarOcorrencia.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new TelaCriarOcorrencia().setVisible(true);
            }
        });
    }
