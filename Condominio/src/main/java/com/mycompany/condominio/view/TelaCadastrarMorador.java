 ...
 * @author marih
 */
public class TelaCadastrarMorador extends javax.swing.JFrame {
    
    /**
     * Creates new form TelaMoradores
     */
    public TelaCadastrarMorador() {
        initComponents();
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        String resultado = MoradorDAO.cadastrarMorador(nome, cpf, telefone, email, unidade);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TelaCadastrarMorador.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        /*java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new TelaCadastrarMorador().setVisible(true);
            }
        });*/
    }
