 ...
 * @author marih
 */
public class TelaVerTaxas1 extends javax.swing.JFrame {

    /**
     * Creates new form TelaMoradores
     */
    public TelaVerTaxas1() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Valor", "Vencimento", "Descrição", "Status", "Unidade"
            }
        ) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TelaVerTaxas1.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new TelaVerTaxas1().setVisible(true);
            }
        });
    }
